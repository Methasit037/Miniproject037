...
echo '<tr>';
echo '<td>'. $row['T_no'] . '</td>';
echo '<td>'. $row['E_Employeee'] . '</td>';
echo '<td>'. $row['E_Name'] . '</td>';
echo '<td>'. $row['E_Address'] . '</td>';
echo '<td>'. $row['E_Tel'] . '</td>';
echo '<td><a role="button"  href="update5.php?T_no='.$row['T_no'].'" class="btn btn-primary">Update</a> ';
echo '<td><a href="delete5.php?T_no='.$row['T_no'].'" class="btn btn-danger">delete</a>';
echo '</tr>';
}
} else {
echo " ";
...
<a href="index5.php" class="btn btn-danger">Add</a>
</div>
