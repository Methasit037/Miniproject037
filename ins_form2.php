...
echo '<td>'. $row['P_Product'] . '</td>';
echo '<td>'. $row['P_Price'] . '</td>';
echo '<td><a role="button"  href="update2.php?n_no='.$row['n_no'].'" class="btn btn-primary">Update</a> ';
echo '<td><a href="delete2.php?n_no='.$row['n_no'].'" class="btn btn-danger">delete</a>';
echo '</tr>';
}
} else {
echo " ";
...
<a href="index2.php" class="btn btn-danger">Add</a>
</div>
