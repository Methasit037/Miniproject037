...
<form  action="create5.php" method="post">
            <div class="mb-3">
                <label for="E_Employeee" class="form-label">Employeee</label>
                <input type="text" class="form-control" name="E_Employeee" required>
            </div>
            <div class="mb-3">
            ...
            <a class="btn" href="ins_form5.php">Back</a>
            </form>
            </div>
