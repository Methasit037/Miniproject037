...
<form  action="create4.php" method="post">
            <div class="mb-3">
                <label for="S_Sell" class="form-label">Sell</label>
                <input type="text" class="form-control" name="S_Sell" required>
            </div>
            <div class="mb-3">
                <label for="S_Quantity" class="form-label">Quantity</label>
                <input type="text" class="form-control" name="S_Quantity" required>
            </div>
            <button type="submit">Create</button>
            <a class="btn" href="ins_form4.php">Back</a>
            </form>
            </div>
