...
echo '<td><a role="button"  href="update3.php?A_no='.$row['A_no'].'" class="btn btn-primary">Update</a> ';
echo '<td><a href="delete3.php?A_no='.$row['A_no'].'" class="btn btn-danger">delete</a>';
echo '</tr>';
}
} else {
echo " ";
...
<a href="index3.php" class="btn btn-danger">Add</a>
</div>
